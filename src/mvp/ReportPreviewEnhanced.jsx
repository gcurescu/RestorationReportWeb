...
const ReportPreview = () => {
  ...
  const getLossTypeCopy = (type) => {
    ...
    if (t === 'fire') return {
      ...
      summary: 'Fire and smoke damage documented at subject property. Direct char is limited to the kitchen; however, smoke and soot have migrated to adjacent first-floor areas via open doorways and the HVAC return. HVAC system shut down on arrival. Dry soot cleaning and deodorization are immediate priorities. Full scope pending adjuster walk.',
      observations: [
        'Char and heat damage confined to kitchen — stovetop, upper cabinets, range hood, and ceiling field',
        'Protein-based smoke residue on walls and ceilings in dining room and hallway; greasy film present',
        'Soot confirmed in HVAC filter and supply registers — ductwork cleaning required before system restart',
        'Fire suppression water on kitchen floor and adjacent dining area; extraction and drying underway',
        'Structural framing above stove area visually inspected; no compromised load-bearing members noted at this time',
      ],
      actions: [
        'Run HEPA air scrubbers continuously until airborne particulate clearance is confirmed',
        'Begin dry soot removal (dry sponge, HEPA vac) on all hard surfaces before any wet methods are applied',
        'Clean or replace HVAC filters and registers before system is returned to service',
        'Apply deodorizing encapsulant to smoke-affected structural surfaces prior to reconstruction',
        'Pack out and catalog salvageable contents; coordinate ultrasonic or ozone cleaning off-site as appropriate',
      ],
    };
    if (t === 'mold') return {
      badge: 'Mold Remediation',
      badgeColor: 'bg-green-100 text-green-800 border border-green-200',
      summary: 'Visible microbial growth identified on drywall substrate in the bathroom. Growth is consistent with sustained elevated moisture from a slow supply line leak. The leak has been repaired by a plumber prior to this assessment. Affected area is localized. Containment and remediation can proceed without full-floor disruption.',
      observations: [
        'Visible mold growth on drywall face and paper backing behind toilet — approximately 4–6 sq ft affected',
        'Moisture meter readings on adjacent drywall elevated at 18–22%; normal reference material reads 9–11%',
        'No visible growth on subfloor or framing at this time; will reassess after drywall removal',
        'Moisture source (supply line) confirmed repaired — no active intrusion present',
        'No visible growth outside the bathroom; HVAC intake not in proximity to affected area',
      ],
      actions: [
        'Establish polyethylene containment barrier with negative air before any removal work begins',
        'Remove affected drywall section with 12" clearance beyond visible growth boundary',
        'Inspect exposed framing and subfloor for secondary growth; treat with EPA-registered biocide if affected',
        'HEPA-vacuum all surfaces within containment after demo; apply biocide to structural surfaces',
        'Do not close containment or begin reconstruction until post-remediation clearance is passed',
      ],
    };
    // Default: Water
    return {
      ...
      summary: 'Category 1 water intrusion from a failed bathroom supply line. Source secured on arrival. Standing water was present in the kitchen and living room at approximately 1–2 inches depth; basement ceiling shows secondary intrusion. Class 2 conditions confirmed — moisture has wicked into wall cavities, floor systems, and structural framing. Drying equipment deployed same day.',
      observations: [
        'Standing water extracted from kitchen and living room upon arrival — approximately 1–2" depth at peak',
        'Hardwood flooring in kitchen showing early cupping; moisture content 26–32% vs. reference of 7–9%',
        'Lower cabinet toe kicks and wall base absorbing water; drywall wicking confirmed to 18–24" height',
        'Basement drywall ceiling water-stained with light deflection in northwest corner — intrusion from above',
        'Carpet and pad in living room fully saturated; pad unlikely to be salvageable in-place',
      ],
      actions: [
        'Maintain drying equipment 24/7; target IICRC S500 dry standard — estimated 3–5 days at current conditions',
        'Log psychrometric readings daily; reposition equipment if any zone is not tracking toward goal',
        'Re-evaluate hardwood flooring on Day 3 — cupping may reverse with sufficient drying, but salvage window is short',
        'Remove and dispose of saturated carpet and pad; cannot be effectively dried in-place',
        'Apply antimicrobial treatment to all affected structural surfaces once dry-down is confirmed',
      ],
    };
  };
